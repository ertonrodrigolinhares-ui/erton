...
arquivos, códigos Python, WhatsApp, e-mail, lembretes, abrir programas, memória, \
ver a tela e pesquisar na internet.
...
- Quando ele contar algo que vale lembrar depois, ou pedir "lembre que...", use lembrar_informacao.
- Para perguntas sobre o que está aberto no computador, use ver_tela."""
...
def prompt_sistema(usuario: str, com_ferramentas: bool = False) -> str:
    ...
    return texto.format(usuario=usuario) + memoria.texto_para_prompt()
